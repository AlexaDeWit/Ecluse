...
Écluse is one person's project right now, so I'll write this plainly and in my own
...
A harassment-free space for everyone, regardless of age, body size, visible or
...
the margins of software, are meant to be safe, welcome, and **centred, not merely
tolerated** here. I name these groups deliberately, and never as a closed list. Their
inclusion and safety is not in tension with the project's health; it is a precondition
for it, and it is not up for debate.
...
It does not sit on the fence between people who cause harm and the people they harm.
Where the two conflict, the safety and dignity of marginalised people come before the
comfort of whoever's words or conduct caused the harm. Complaints of "reverse"
discrimination, tone-policing, or demands for false balance are not, in themselves,
valid grievances here.

## Disqualifying affiliations

Active and ongoing participation in, membership of, or promotion of an organised hate
group (a movement whose purpose or activity is the dehumanisation, persecution, or
exclusion of people on the basis of the characteristics named above, for example
neo-Nazi, white-supremacist, or anti-LGBTQ+ extremist organisations such as the Proud
Boys) is fundamentally incompatible with taking part in this project.

That kind of affiliation is itself a credible threat to the people this Code exists to
protect, no matter how courteously the person behaves in project spaces. Unlike
everything else here, it applies regardless of where the affiliation or conduct occurs.
It is grounds for **immediate and permanent removal**, at my discretion, without any of
the benefit of the doubt I would otherwise extend.

## Reporting, and what I will do about it

If you see or experience behaviour that breaks this Code, report it to me,
[@AlexaDeWit](https://github.com/AlexaDeWit). I will review and look into every report
as fairly and carefully as I can, and I will respect the privacy and security of
whoever raised it.
...
* **There is no formal enforcement ladder, because there is no panel to run one.**
  ...
  and I am the one who decides. The disqualifying-affiliations clause above is the one
  case that skips straight to permanent removal.

As the project grows, and ideally picks up co-maintainers, this will need to grow with
it. Until then, this is the honest version.
