...
check "boot lib, single-component version" \
  ...
  'href="https://hackage.haskell.org/package/containers-0.7/docs/Data-Map.html#t:Map"'
...
check "store dep, hyphenated package name" \
  ...
  'href="https://hackage.haskell.org/package/amazonka-core-2.0/docs/Amazonka-Core.html#t:Service"'
...
check "store dep, hash starting with a digit (version not eaten)" \
  ...
  'href="https://hackage.haskell.org/package/hs-opentelemetry-api-1.0.0.0/docs/OpenTelemetry-Trace.html#t:Tracer"'
...
check "doc-index.json escaped href" \
  ...
  '"display":"<a href=\"https://hackage.haskell.org/package/base-4.20.2.0/docs/System-IO.html#t:IO\">IO</a>"'
...
if printf '%s' "$rewritten" | grep -qE '/home/|file://|\$\{pkgroot\}'; then
