...
@docs\/architecture\/registry-model.md@ → "Credential flow and authority"). The invariant is the __public strip__: the client's credential is __stripped before any public-upstream
