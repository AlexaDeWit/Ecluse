...
admits the URL-path name and the body is read, **every present declared body name**,`_id`, top-level `name`, and each `versions[].name`, is compared to the URL-path name,
