...
disclosure hazard, [threat #9](https://alexadewit.github.io/Ecluse/threat-model.html)). Only the
...
- **Collision → private wins; divergence is a signal.** On a shared version key the private copy
  ...
  ([threat #11](https://alexadewit.github.io/Ecluse/threat-model.html)): detected, logged, and
...
[threat #10](https://alexadewit.github.io/Ecluse/threat-model.html)).
