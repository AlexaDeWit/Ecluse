...
**File scope.**
- `test/integration/Ecluse/Server/<…>Spec.hs` (or the existing tarball/streaming spec),  the residency-invariant + cap assertions; a synthetic large-body source helper.
