...
"Ecluse.Ecosystem": semver for npm ("Ecluse.Version.Semver"), PEP 440 for PyPI
("Ecluse.Version.Pep440"), @Gem::Version@ for RubyGems ("Ecluse.Version.Gem").
...
import Ecluse.Version.Gem (GemKey, isGemStable, parseGem)
import Ecluse.Version.Pep440 (Pep440Key, isPep440Stable, parsePep440)
import Ecluse.Version.Semver (SemverKey, isSemverStable, parseSemver)
